          ...
          <div className="h-full overflow-y-auto pt-8 pb-24 px-4">
            ...
            {isAuthenticated ? (
              ...
              <div className="mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                <Link to="/api/login" className="block w-full py-2 px-4 bg-primary hover:bg-primary-dark text-white text-center rounded-lg transition-colors">
                  Giriş Yap
                </Link>
              </div>
            )}
            ...
            <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
              {isAuthenticated && (
                <Link to="/api/logout" className="flex items-center space-x-3 p-3 rounded-lg text-red-500 hover:bg-red-50 dark:hover:bg-red-900 dark:hover:bg-opacity-20">
