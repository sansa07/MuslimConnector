...
// Yaklaşık bir Hicri tarih hesaplama (API çalışmazsa yedek olarak)
          ...
          <div>
            <div className="text-center mb-4">
              <p className="text-2xl font-bold">
                {hijriData?.hijri.date} {hijriMonthsTR[hijriData?.hijri.month.number ? hijriData.hijri.month.number - 1 : 0]} {hijriData?.hijri.year}
              </p>
